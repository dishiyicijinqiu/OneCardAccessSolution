...
{
    public class ListenableList<T> : IList<T>, ICollection<T>, IEnumerable<T>
    {
        ...
        public void Insert(int index, T item)
        {
            ...
            {
                ElementAdded(this, new ListenableList<T>.ElementAddedEventArgs<T>(item, index));
            }
        }
        ...
        public void RemoveAt(int index)
        {
            ...
            {
                ElementRemoved(this, new ListenableList<T>.ElementRemovedEventArgs<T>(item, index));
            }
        }
        ...
        public void Clear()
        {
            ...
            if (ElementRemoved != null)
            {
                ...
                {
                    ElementRemoved(this, new ListenableList<T>.ElementRemovedEventArgs<T>(copyItems[i], i));
                }
            }
        }
        ...
        public class ElementAddedEventArgs<U> : EventArgs
        {
            private U item;
            private int index = 0;

            public ElementAddedEventArgs(U item, int index)
            {
                this.item = item;
                this.index = index;
            }
        ...
        public class ElementRemovedEventArgs<S> : EventArgs
        {
            private S item;
            private int index = 0;

            public ElementRemovedEventArgs(S item, int index)
            {
                this.item = item;
                this.index = index;
            }
        ...
        public delegate void ElementAddedDelegate(ListenableList<T> sender, ElementAddedEventArgs<T> args);
        public delegate void ElementRemovedDelegate(ListenableList<T> sender, ElementRemovedEventArgs<T> args);
        #endregion
