...
(function ($) {
    ...
    $.fn.Ribbon = function (ribbonSettings) {
        var settings = $.extend({ }, ribbonSettings || {});
        ...
        function SetupMenu(settings) {
            ...
            $('.ribbon-list>div').click(function (e) {
                ...
                if (insideX && insideY) {
                    ...
                    if ($('.ribbon-list>div>ul:visible').length > 0) {
        ...
        $('.orb li:first ul:first').prepend('<img src="ribbon/themes/office2010blue/images/menu_top.png" style="margin-left: -10px; margin-top: -22px;" />');
        $('.orb li:first ul:first').append('<img src="ribbon/themes/office2010blue/images/menu_bottom.png" style="margin-left: -10px; margin-bottom: -22px;" />');

        $('.ribbon-list div').each(function () { if ($(this).children('ul').length > 0) { $(this).append('<img src="ribbon/themes/office2010blue/images/arrow_down.png" style="float: right; margin-top: 5px;" />') } });
